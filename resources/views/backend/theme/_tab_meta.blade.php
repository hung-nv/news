    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control maxlength-handler" name="meta_title" maxlength="100"
                   placeholder="" value="{{ isset($option) ? $option['meta_title'] : old('meta_title') }}">
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <textarea class="form-control maxlength-handler" rows="8" name="meta_description"
                      maxlength="255">{{ isset($option) ? $option['meta_description'] : old('meta_description') }}</textarea>
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <textarea class="form-control maxlength-handler" rows="8" name="meta_keywords"
                      maxlength="1000">{{ isset($option) ? $option['meta_keywords'] : old('meta_keywords') }}</textarea>
            <span class="help-block"> max 255 chars </span>
        </div>
    </div>
</div>