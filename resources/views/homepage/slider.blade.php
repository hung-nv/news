            ...
            <ul>
                ...
                @if(!empty($option['banner_image_1']))
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                        ...
                        data-saveperformance="off" data-title="We Are Avendor">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset($option['banner_image_1']) }}" alt="slidebg1" data-bgfit="cover"
                             data-bgposition="center center" data-bgrepeat="no-repeat">

                        @if(!empty($option['banner_title_1']))
                            <div class="tp-caption large_bold_white customin customout tp-resizeme rs-parallaxlevel-3"
                                ...
                                {{ $option['banner_title_1'] }}
                            </div>
                        @endif

                        @if(!empty($option['banner_description_1']))
                            <div class="tp-caption mediumlarge_light_white customin customout rs-parallaxlevel-4"
                                 data-x="center"
                                 data-y="250"
                                 ...
                                 data-endeasing="Power3.easeInOut"
                                 data-captionhidden="on"
                                 style="z-index: 4; font-size:30px;">
                                {{ $option['banner_description_1'] }}
                            </div>
                        @endif
                        ...
                        <div class="tp-caption sfb rs-parallaxlevel-5"
                             ...
                             style="z-index: 6">
                            <a href="#why-us" class="btn btn-primary btn-lg">Xem thêm! <i
                                        class="fa fa-angle-double-down iconright"></i></a>
                        </div>
                ...
                @if(!empty($option['banner_image_2']))
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                        data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7"
                        data-saveperformance="off" data-title="Amazing Features">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset($option['banner_image_2']) }}" alt="slidebg2" data-bgfit="cover"
                             data-bgposition="center center" data-bgrepeat="no-repeat">

                        @if(!empty($option['banner_title_2']))
                            <div class="tp-caption large_bold_white customin customout rs-parallaxlevel-3"
                                 ...
                                 data-endeasing="Power3.easeInOut"
                                 data-captionhidden="on"
                                 style="font-size:90px;line-height:110px;">
                                {{ $option['banner_title_2'] }}
                            </div>
                        @endif

                        @if(!empty($option['banner_description_2']))
                            <div class="tp-caption mediumlarge_light_white customin customout rs-parallaxlevel-4"
                                 data-x="center"
                                 data-y="280"
                                 ...
                                 data-captionhidden="on"
                                 style="z-index: 4; font-size:52px;">
                                {{ $option['banner_description_2'] }}
                            </div>
                        @endif
                        ...
                        <div class="tp-caption sfb rs-parallaxlevel-5"
                             ...
                             data-captionhidden="off"
                             style="z-index: 6">
                            <a href="#services" class="btn btn-white btn-lg btn-alt">
                                Dịch vụ
                                <i class="fa fa-angle-double-down iconright"></i>
                            </a>
                        </div>
                ...
                @if(!empty($option['banner_image_3']))
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                        data-thumb="{{ asset($option['banner_image_3']) }}" data-fstransition="fade"
                        data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"
                        data-title="Free on the Beach">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset($option['banner_image_3']) }}" alt="video_woman_cover3"
